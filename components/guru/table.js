        ...
        <>
            <div className="bg-white shadow-lg border mx-6">
                <div className="flex justify-between items-center p-4">
                    <p className="text-gray-500">Data Guru</p>
                ...
                <table className="w-full text-left px-6">
                    <thead className="bg-gray-200">
                        <tr>
                            ...
                            <th className="px-4 py-2">Mengajar</th>
                    ...
                    <tbody className="text-sm text-gray-500">
                        <tr className="hover:bg-gray-100">
                            ...
                            <td className="px-4 py-2">
                                <button type="button" className="border rounded border-cyan-400 py-1 px-2 mr-2 bg-cyan-500 hover:bg-opacity-0 text-white hover:text-gray-900">
                                    <i className="material-icons md-18">edit</i>
                                </button>
                                <button type="button" className="border rounded border-red-400 py-1 px-2 bg-red-400 hover:bg-opacity-0 text-white hover:text-gray-900">
